...
class MainWindow : public QMainWindow
{
    ...
    public slots:
      ...
      *******************************************/
        ...
        void slot_speed_Z(double z);//新增

        void slot_accelerograph();//油门模式启动的脚本
        //void slot_camera_yuntai_control(const int &control_number);// 摄像头的云台控制
        void slot_camera_control_up();//puttern绑定槽函数
        void slot_camera_control_down();//puttern绑定槽函数
        void slot_camera_control_left();//puttern绑定槽函数
        void slot_camera_control_right();//puttern绑定槽函数
    ...
    //    void on_horizontalSlider_raw_valueChanged(int value);
        ...
        // 升降杆
        void slot_direction_up();
        void slot_direction_down();
        void slot_motor_stop();
        void slot_speed_mode_execute();
        void slot_set_zero();
        void slot_back_zero();
